...
def convert_a_stock_to_jsonl(
    csv_path: str = './A_stock/daily_prices_sse_50.csv',
    output_path: str = './A_stock/merged.jsonl'
) -> None:
            ...
            for idx, row in group_df.iterrows():
                ...
                if date_str == latest_date:
                    ...
                    time_series[date_formatted] = {
                        ...
                        "5. volume": str(int(row['vol'] * 100)) if pd.notna(row['vol']) else "0"  # Convert to shares (vol is in 手, 1手=100股)
                    }
