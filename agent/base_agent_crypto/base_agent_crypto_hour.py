...
class BaseAgentCrypto_Hour(BaseAgentCrypto):
    """
    ...
    def get_trading_dates(self, init_date: str, end_date: str) -> List[str]:
        ...
        merged_file = base_dir / "data" / "crypto" / "crypto_hourly_merged.jsonl"
    ...
    def __str__(self) -> str:
        return f"BaseAgentCrypto_Hour(signature='{self.signature}', basemodel='{self.basemodel}', crypto_symbols={len(self.crypto_symbols)})"
